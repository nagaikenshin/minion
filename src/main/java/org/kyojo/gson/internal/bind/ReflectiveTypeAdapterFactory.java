...
import org.kyojo.gson.FieldNamingStrategy;
...
import org.kyojo.gson.annotations.JsonAdapter;
import org.kyojo.gson.annotations.SerializedName;
...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
  ...
  static abstract class BoundField implements Comparable<BoundField> {
    final String name;
    ...
    @Override
    public int compareTo(BoundField bf) {
        return name.compareTo(bf.name);
    }
  }
  ...
  public static final class Adapter<T> extends TypeAdapter<T> {
    ...
    @Override public void write(JsonWriter out, T value) throws IOException {
      ...
      out.beginObject();
      try {
        List<BoundField> bfs = new ArrayList<BoundField>(boundFields.values());
        Collections.sort(bfs);
        for (BoundField boundField : bfs) {
